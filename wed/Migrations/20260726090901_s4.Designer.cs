            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1f40cd6e-91f7-4c2f-a5b2-207698e2ffa0"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 26, 16, 9, 1, 320, DateTimeKind.Local).AddTicks(9834),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 16, 9, 1, 320, DateTimeKind.Local).AddTicks(9997),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 16, 9, 1, 321, DateTimeKind.Local).AddTicks(135),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 16, 9, 1, 321, DateTimeKind.Local).AddTicks(138),
                            Name = "Article",
                            ParentId = new Guid("f053ba68-398a-4019-87a1-5bc9466e9fe4")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 16, 9, 1, 321, DateTimeKind.Local).AddTicks(141),
                            Name = "Product",
                            ParentId = new Guid("f053ba68-398a-4019-87a1-5bc9466e9fe4")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 26, 16, 9, 1, 319, DateTimeKind.Local).AddTicks(8350),
