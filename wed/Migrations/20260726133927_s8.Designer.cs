            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("61046c52-161b-4b34-ae2e-31b920a5ea6f"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 26, 20, 39, 26, 670, DateTimeKind.Local).AddTicks(1377),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 20, 39, 26, 670, DateTimeKind.Local).AddTicks(1623),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 20, 39, 26, 670, DateTimeKind.Local).AddTicks(1820),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 20, 39, 26, 670, DateTimeKind.Local).AddTicks(1824),
                            Name = "Article",
                            ParentId = new Guid("f053ba68-398a-4019-87a1-5bc9466e9fe4")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 20, 39, 26, 670, DateTimeKind.Local).AddTicks(1828),
                            Name = "Product",
                            ParentId = new Guid("f053ba68-398a-4019-87a1-5bc9466e9fe4")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 26, 20, 39, 26, 668, DateTimeKind.Local).AddTicks(4277),
