            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d64279ff-ffd7-4f88-8744-aadf57fc7234"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 26, 19, 34, 45, 297, DateTimeKind.Local).AddTicks(1625),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 19, 34, 45, 297, DateTimeKind.Local).AddTicks(1819),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 19, 34, 45, 297, DateTimeKind.Local).AddTicks(1985),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 19, 34, 45, 297, DateTimeKind.Local).AddTicks(1989),
                            Name = "Article",
                            ParentId = new Guid("f053ba68-398a-4019-87a1-5bc9466e9fe4")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 19, 34, 45, 297, DateTimeKind.Local).AddTicks(1992),
                            Name = "Product",
                            ParentId = new Guid("f053ba68-398a-4019-87a1-5bc9466e9fe4")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 26, 19, 34, 45, 295, DateTimeKind.Local).AddTicks(6954),
