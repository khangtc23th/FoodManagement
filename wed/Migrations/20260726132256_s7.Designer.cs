            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("01aa570c-dc1e-45fe-94bb-e0822f55ffd1"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 26, 20, 22, 56, 219, DateTimeKind.Local).AddTicks(6933),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 20, 22, 56, 219, DateTimeKind.Local).AddTicks(7104),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 20, 22, 56, 219, DateTimeKind.Local).AddTicks(7256),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 20, 22, 56, 219, DateTimeKind.Local).AddTicks(7259),
                            Name = "Article",
                            ParentId = new Guid("f053ba68-398a-4019-87a1-5bc9466e9fe4")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("11336570-9607-4634-8244-207e19971e98"),
                            CreatedOn = new DateTime(2026, 7, 26, 20, 22, 56, 219, DateTimeKind.Local).AddTicks(7261),
                            Name = "Product",
                            ParentId = new Guid("f053ba68-398a-4019-87a1-5bc9466e9fe4")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 7, 26, 20, 22, 56, 218, DateTimeKind.Local).AddTicks(3963),
